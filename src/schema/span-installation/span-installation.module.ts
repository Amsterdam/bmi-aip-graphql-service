...
import { UpdateOVSDecompositionHandler } from './commands/update-ovs-decomposition.handler';
...
@Module({
	providers: [
		...
		OVSDecompositionRepository,
		UpdateOVSDecompositionCommand,
		UpdateOVSDecompositionHandler,
	],
