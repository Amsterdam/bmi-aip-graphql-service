...
const facadeSurveyServiceMock: MockedObjectDeep<FacadeSurveyService> = { ...(<any>{}) };
const mastSurveyServiceMock: MockedObjectDeep<MastSurveyService> = { ...(<any>{}) };
const nodeSurveyServiceMock: MockedObjectDeep<NodeSurveyService> = { ...(<any>{}) };
const tensionWireSurveyServiceMock: MockedObjectDeep<TensionWireSurveyService> = { ...(<any>{}) };
const luminaireSurveyServiceMock: MockedObjectDeep<LuminaireSurveyService> = { ...(<any>{}) };
